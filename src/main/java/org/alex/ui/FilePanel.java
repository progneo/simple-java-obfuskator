...
public class FilePanel extends JPanel {
  ...
  public FilePanel() {
    ...
    JButton inputButton = getjButton(inputField);
    ...
    JButton outputButton = getjButton(outputField);
  ...
  private JButton getjButton(JTextField inputField) {
    ...
    inputButton.addActionListener(
        (e) -> {
          ...
          if (Path != null) chooser.setCurrentDirectory(Path);
